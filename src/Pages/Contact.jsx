...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const formSubmitUrl =
        "https://formsubmit.co/mohameddarhoub36@gmail.com";
      ...
      // formsubmit sometimes returns CORS 0 in dev – treat as success
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] ">
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          I’m Mohamed Darhoub — a Computer Science student with strong interest
          in Linux (Red Hat), cybersecurity, networking, and software
          development. Feel free to reach out for internships, collaborations,
          or any inquiries.
        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Whether it's about Linux, cybersecurity, networking, Python,
                  C++, or software development — I’m always open to discussions.
                </p>
              </div>
