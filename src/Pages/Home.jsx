...
// No badge at the very top anymore
const StatusBadge = memo(() => null);

// Title: just text gradients, no background shapes
...
const WORDS = ["Cybersecurity & Linux Enthusiast"];
...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/m7sd" },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/mohamed-darhoub-b07142327/",
  },
  { icon: Instagram, link: "https://www.instagram.com/xyzguyss" },
];
            ...
            >
              <div className="space-y-3 sm:space-y-4">
                ...
                <p
                  ...
                  data-aos-delay="800"
                >
                  I&apos;m a Computer Science student focused on Linux (Red Hat),
                  cybersecurity, networking, and programming with Python, C/C++,
                  Java, and SQL. I enjoy understanding how systems work from the
                  operating-system and network level all the way up to
