...
const AboutPage = () => {
  // >>> Set your own numbers here <<<
  const totalProjects = 6;       // number of projects
  const totalCertificates = 4;   // update when you have certificates
  const YearExperience = 3;      // years of learning
    ...
    () => [
      {
        ...
        description: "Hands-on labs and technical exercises",
      ...
      },
      {
        ...
        label: "Certificates",
        description: "Courses and trainings completed",
        animation: "fade-up",
      },
      {
        icon: Globe,
        ...
        description: "Continuous growth in CS & security",
        animation: "fade-left",
      },
    ],
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              ...
              Linux (Red Hat), cybersecurity, and computer networking. I enjoy
              understanding how systems work from the operating system and
              network layers up to applications and databases, using tools like
              Python, C/C++, Java, and SQL. My goal is to build secure,
              reliable, and well-engineered systems while constantly improving
              through practice and real projects.
            </p>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              {/* TODO: replace href with your real CV link */}
