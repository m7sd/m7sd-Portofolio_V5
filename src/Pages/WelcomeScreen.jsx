            ...
            <div className="w-full max-w-4xl mx-auto">
              ...
              >
                ...
                <p
                  ...
                  data-aos-delay="1100"
                >
                  Hi, I&apos;m <span className="font-semibold">Mohamed Darhoub</span>, 
                  a Computer Science student passionate about Linux (Red Hat),
                  cybersecurity, networking, and programming.
                </p>
              </motion.div>

              {/* Website Tagline / Link (purely visual, can be any text) */}
              <motion.div
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 sm:px-6 sm:py-3 rounded-full relative group">
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
                      <TypewriterEffect text="Mohamed Darhoub Portfolio" />
                    </span>
                  </div>
                </div>
              </motion.div>
